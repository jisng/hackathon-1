...
struct TagData {
    ...
    static let transTag = TagModel(name: "교통", image: UIImage(named: "")!, color: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))
    static let phoneTag = TagModel(name: "통신", image: UIImage(named: "")!, color: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))
